  ...
  return (
    <>
      <section className="mx-auto max-w-4xl px-6 pb-24 pt-32 text-center">
        ...
        <h1 className="mb-6 text-5xl font-bold leading-[1.05] tracking-tight text-white md:text-7xl">
        ...
        <div className="flex flex-wrap justify-center gap-12 border-t border-[#1E2D40] pt-10">
          {[
      ...
      {showSample && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6" onClick={() => setShowSample(false)}>
          ...
          <div className="relative w-full max-w-2xl rounded-2xl border border-[#1E2D40] bg-[#0F1623] p-6" onClick={e => e.stopPropagation()}>
