...
export function UseCases() {
  return (
    <section className="mx-auto max-w-6xl px-6 py-20">
      ...
      <h2 className="mb-10 mt-2 text-4xl font-bold text-white">Built for high-stakes deployments</h2>
      <div className="grid gap-4 md:grid-cols-3">
        {cases.map(([icon, title, desc]) => (
          <div key={title} className="cursor-default rounded-xl border border-[#1E2D40] bg-[#0F1623] p-6 transition-all hover:border-[#243244]">
