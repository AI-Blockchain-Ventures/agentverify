...
// Nothing else in the reference spells a tag, a type or a purpose. domains.v3.json freezes this table and a test proves it is
...
/** The five interpretation-version fields. Each is bound independently in the payload and the assessment; none is pinned by the profile registry. */
